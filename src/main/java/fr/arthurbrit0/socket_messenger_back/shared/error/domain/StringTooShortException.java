package fr.arthurbrit0.socket_messenger_back.shared.error.domain;
...
public final class StringTooShortException extends AssertionException {
    ...
    static final class StringTooShortExceptionBuilder {
        ...
        private String message() {
            return "O valor \"%s\" no campo \"%s\" tem que ter no mínimo %d caracteres mas teve apenas %d".formatted(value, field, minLength, value.length());
        }
